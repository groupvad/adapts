...
class StudentNet(nn.Module):
    def __init__(self, ed=True):
        ...
        if self.ed:
            ...
            self.decoder_layer4 = make_layer(BasicBlock, 2048, 2048, 2)
            self.decoder_layer3 = make_layer(BasicBlock, 2048, 1024, 2)
            self.decoder_layer2 = make_layer(BasicBlock, 1024, 512, 2)
            self.decoder_layer1 = make_layer(BasicBlock, 512, 256, 2)
